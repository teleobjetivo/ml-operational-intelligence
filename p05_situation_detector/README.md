...
## Qué incluye
- Dataset simulado: `data/p05_situation_detector_data.csv`
- Notebook runnable: `notebooks/p05_situation_detector.ipynb`
- Figura exportada: `img/p05_situation_detector_plot.png`
