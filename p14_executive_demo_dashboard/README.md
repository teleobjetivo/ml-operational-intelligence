# P14 — Executive Demo Dashboard

_Dashboard HTML simple que junta resultados clave y figuras del repo._

## Resumen

Soy Hugo Baghetti. Genera un HTML local con KPIs y enlaces a outputs para demo de entrevista.
...
- `README.md`
- `notebooks/p14_executive_demo_dashboard.ipynb`
...
_A simple HTML dashboard aggregating key results and plots from the repo._

## Summary

I'm Hugo Baghetti. Generates a local HTML with KPIs and links to outputs for interview demos.
