# P13 — Alert-to-Action Orchestrator

_Orquesta alertas → acciones (simuladas) con reglas y cola simple._

## Resumen

Soy Hugo Baghetti. Toma alertas del detector, aplica reglas y genera un ‘plan de acción’ con prioridad.
...
- `README.md`
- `notebooks/p13_alert_to_action_orchestrator.ipynb`
...
_Orchestrates alerts → (simulated) actions via rules and a simple queue._

## Summary

I'm Hugo Baghetti. Consumes detector alerts, applies rules, and outputs an ‘action plan’ with priority.
