# P08 — Data Quality Sentinel

_Vigilante de calidad: nulos, outliers, cambios de esquema y reglas._

## Resumen

Soy Hugo Baghetti. Perfila un dataset simulado, aplica reglas, y emite un reporte de hallazgos con severidad.
...
- `README.md`
- `notebooks/p08_data_quality_sentinel.ipynb`
...
_Quality guard: nulls, outliers, schema changes, and rules._

## Summary

I'm Hugo Baghetti. Profiles a simulated dataset, applies rules, and outputs a findings report with severity.
