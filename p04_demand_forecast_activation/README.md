...
**EN title:** Demand Forecast + Activation
...
## Qué incluye
- Dataset simulado: `data/p04_demand_forecast_activation_data.csv`
- Notebook runnable: `notebooks/p04_demand_forecast_activation.ipynb`
- Figura exportada: `img/p04_demand_forecast_activation_plot.png`
