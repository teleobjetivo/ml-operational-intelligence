# P03 — Clasificación de estados operacionales

_Clasifica estados (Normal / Alerta / Crítico) a partir de variables y umbrales/modelo._

## Resumen

Soy Hugo Baghetti. Construye etiquetas de estado y entrena un clasificador simple, entregando matriz de confusión y gráfico.
...
- `README.md`
- `notebooks/p03_operational_state_classifier.ipynb`
...
# P03 — Operational state classification

_Classifies states (Normal / Warning / Critical) from variables using thresholds/model._

## Summary

I'm Hugo Baghetti. Builds state labels and trains a simple classifier, producing a confusion matrix and plot.
