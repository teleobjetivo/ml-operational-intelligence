...
**EN title:** Operational State Classifier
...
## Qué incluye
- Dataset simulado: `data/p03_operational_state_classifier_data.csv`
- Notebook runnable: `notebooks/p03_operational_state_classifier.ipynb`
- Figura exportada: `img/p03_operational_state_classifier_plot.png`
