# P07 — Atlas de Tendencias

_Agrupa series/variables y sintetiza tendencias en lenguaje ejecutivo._

## Resumen

Soy Hugo Baghetti. Calcula features de tendencia, agrupa con clustering y genera un mini ‘atlas’ de clusters + gráficos.
...
- `README.md`
- `notebooks/p07_trend_atlas.ipynb`
...
_Clusters series/variables and summarizes trends in executive language._

## Summary

I'm Hugo Baghetti. Computes trend features, clusters them, and generates a mini ‘atlas’ of clusters + plots.
