# P12 — KPI Narrative Generator

_Convierte KPIs en narrativa ejecutiva: ‘qué pasó y por qué importa’._

## Resumen

Soy Hugo Baghetti. Calcula KPIs de ejemplo y genera un texto estructurado con insights y riesgos.
...
- `README.md`
- `notebooks/p12_kpi_narrative_generator.ipynb`
...
_Turns KPIs into executive narrative: ‘what happened and why it matters’._

## Summary

I'm Hugo Baghetti. Computes sample KPIs and generates a structured text with insights and risks.
