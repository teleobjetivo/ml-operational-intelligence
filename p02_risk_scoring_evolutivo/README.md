# P02 — Risk Scoring Evolutivo: Riesgo dinámico en el tiempo

_Score de riesgo que cambia según comportamiento reciente y drift._

## Resumen

Soy Hugo Baghetti. Simula features y un target de riesgo; entrena un modelo base y muestra cómo el score cambia por ventanas temporales.
...
- `README.md`
- `notebooks/p02_risk_scoring_evolutivo.ipynb`
...
# P02 — Evolutionary Risk Scoring: Dynamic risk over time

_A risk score that adapts with recent behavior and drift signals._

## Summary

I'm Hugo Baghetti. Simulates features and a risk target; trains a baseline model and shows how scoring changes across rolling windows.
