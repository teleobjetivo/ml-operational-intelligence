# p10 — Sugeridor de causa raíz para anomalías

**EN title:** Root Cause Suggester
...
## Qué incluye
- Dataset simulado: `data/p10_root_cause_suggester_data.csv`
- Notebook runnable: `notebooks/p10_root_cause_suggester.ipynb`
- Figura exportada: `img/p10_root_cause_suggester_plot.png`
