# P01 — Event Early Warning: Detección temprana de anomalías

_Monitoreo de señales y alertas tempranas para anticipar eventos operacionales._
...
- `README.md`
- `notebooks/p01_event_early_warning.ipynb`
...
# P01 — Event Early Warning: Early anomaly detection

_Signal monitoring and early alerts to anticipate operational events._

## Summary

I'm Hugo Baghetti. Generates a simulated time series with injected anomalies, detects out-of-pattern points, and outputs a simple alert + figure.
