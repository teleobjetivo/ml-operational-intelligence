# p01 — Detección temprana de eventos anómalos

**EN title:** Event Early Warning
...
## Qué incluye
- Dataset simulado: `data/p01_event_early_warning_data.csv`
- Notebook runnable: `notebooks/p01_event_early_warning.ipynb`
- Figura exportada: `img/p01_event_early_warning_plot.png`
