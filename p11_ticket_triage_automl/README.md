# P11 — Ticket Triage (AutoML-lite)

_Prioriza y enruta tickets con clasificación ligera y reglas._

## Resumen

Soy Hugo Baghetti. Simula tickets; clasifica prioridad; sugiere equipo y SLA; genera tabla de salida.
...
- `README.md`
- `notebooks/p11_ticket_triage_automl.ipynb`
...
_Prioritizes and routes tickets via lightweight classification and rules._

## Summary

I'm Hugo Baghetti. Simulates tickets; predicts priority; suggests team and SLA; outputs a table.
