# p11 — Priorización de tickets con ML simple

**EN title:** Ticket Triage (AutoML-lite)
...
## Qué incluye
- Dataset simulado: `data/p11_ticket_triage_automl_data.csv`
- Notebook runnable: `notebooks/p11_ticket_triage_automl.ipynb`
- Figura exportada: `img/p11_ticket_triage_automl_plot.png`
