# P09 — Model Drift Monitor

_Monitorea drift de datos/modelo para mantener performance._

## Resumen

Soy Hugo Baghetti. Simula drift; compara distribuciones y reporta alertas (PSI/estadísticos simples).
...
- `README.md`
- `notebooks/p09_model_drift_monitor.ipynb`
...
_Monitors data/model drift to keep performance stable._

## Summary

I'm Hugo Baghetti. Simulates drift; compares distributions and reports alerts (PSI/simple stats).
